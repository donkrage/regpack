...
.reg files for essential optimization of Windows 10 and 11 Registry
...
|edgeX.bat - disable autoupdate services and background processes of Microsoft Edge
|explorer.reg - basic Windows Explorer setup
|filesystem.reg - File System optimization
|foldernetworkX.reg - remove folder «Network» from Navigation pane
|fse.reg - global disable of Fullscreen optimizations (requires Xbox components installed)
|gamedvr.reg - disable Game Bar
...
|nvtelemetry.reg - disable NVIDIA Control Panel telemetry
|oldphotoviewer.reg - get back old Windows Photo Viewer
|search.reg - disable web results in Windows Search
|systemprofile.reg - reduce percent of resources reserved for low-priority tasks
|systemrestore.reg - disable System Restore
|telemetry.reg - disable basic telemetry
|uac.reg - disable User Account Control

Windows 10 Only
|win10defenderX.reg - fully disable Windows Defender, including exploits
|win10folder3d.reg - remove «3D Objects» folder in Windows Explorer (Win 11 doesnt include this folder)
|win10networkwizard.reg - disable network setup wizard on new networks
|win10priority.reg - higher priority for Games
...
|win11defenderX.bat - fully disable Windows Defender, including exploits
|win11priority.reg - higher priority for Games
